...
export default function CustomCursor() {
  ...
  // Detect `[data-cursor="view"]` hover targets
  useEffect(() => {
  ...
  }, [location.pathname]) // ✅ re-run after page change
  ...
  return (
    <>
      ...
      {/* Rotating SVG appears only when hovering data-cursor="view" */}
      {isHovering && (
        <div
